...
#load("RE_design_matrix_1YFU.RData")
...
x11()
plot(FR$time, FR$surv^Rpredictor,ylim = c(0,1),type = "l",col="red", lwd=1,xlab = "time",ylab="Survival Probability")
lines(FD$time, FD$surv^Dpredictor,ylim = c(0,1),type = "l",col="green", lwd=1)

# Save Results
FU_try <- list(beta=Omega0[1:n_beta],gamma=Omega0[(n_beta+1):(n_beta+n_gamma)],
